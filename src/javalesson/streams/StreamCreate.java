...
public class StreamCreate {
    public static void main(String[] args) throws IOException {
        ...
        streamFromFiles = Files.lines(Paths.get("11.txt"));
        String[] arrayFromStream = streamFromFiles.toArray(String[]::new);
        for(String str: arrayFromStream){
            System.out.println(str);
        }
        List<String> list = Stream.of(arrayFromStream).sorted().collect(Collectors.toList());
        ...
        IntStream characterStream = "rzdbgrtnblkdnbvk".chars();
        characterStream.sorted().forEach(x-> System.out.println(x));
